...
#SBATCH -o /rds/user/yg330/hpc-work/pgs_img_2/SSHscript/GWAS_log/global_DTI_GWAS_25112024.log
#SBATCH -e /rds/user/yg330/hpc-work/pgs_img_2/SSHscript/GWAS_log/global_DTI_GWAS_25112024.err
#SBATCH -p sapphire
#SBATCH -t 5:00:00
#SBATCH --mem=100G
...
for i in {1..5}; do
  gcta --fastGWA-mlm \
       ...
       --out ./MRI_Global_GWAS/25112024_mad.GWAS_DTI_regional_pheno"$i"
done
